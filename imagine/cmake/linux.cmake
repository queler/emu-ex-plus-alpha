...
if(NOT CMAKE_C_COMPILER)
	find_program(LINUX_CC NAMES ${CTARGET}-gcc-16 gcc-16 REQUIRED)
	find_program(LINUX_CXX NAMES ${CTARGET}-g++-16 g++-16 REQUIRED)
	set(CMAKE_C_COMPILER ${LINUX_CC})
	set(CMAKE_CXX_COMPILER ${LINUX_CXX})
	find_program(LINUX_AR NAMES ${CTARGET}-gcc-ar gcc-ar)
	if(LINUX_AR)
		set(CMAKE_AR ${LINUX_AR})
	endif()
	find_program(LINUX_RANLIB NAMES ${CTARGET}-gcc-ranlib gcc-ranlib)
	if(LINUX_RANLIB)
